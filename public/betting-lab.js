...
export function mount({ onClose }) {
  ...
  function renderBetTab() {
    ...
    return `
      ...
      <section class="kbl-hero" aria-label="KickPot betting"><div class="kbl-hero-copy"><strong>Same game.<br>Bigger moments.</strong><span>BACK YOUR KNOWLEDGE</span></div><div class="kbl-hero-player" aria-hidden="true"><span>SPURS</span><b>7</b></div><div class="kbl-hero-steps">PREDICT<br>BACK<br>COMPETE<br>WIN TOGETHER</div></section>
